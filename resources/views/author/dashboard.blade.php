                        ...
                        <table class="table table-hover dashboard-task-infos">
                            <thead>
                                <tr>
                                    ...
                                    <th width="20%" class="text-Center">Favorite</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="20%" class="text-Center">{{str_limit($post->title,30)}}</td>
                                    <td width="20%" class="text-Center">{{$post->view_count}}</td>
                                    <td width="20%" class="text-Center">{{$post->favorite_to_users_count}}</td>
                                    <td width="20%" class="text-Center">{{$post->comments_count}}</td>
